...
Файлы выводятся в порядке возрастания количества подробных просмотров(или скачиваний). Пока
без учёта того, что один пользователь может скачать файл несколько раз.
